...
export declare class FunctionsRegistry {
    ...
    private settings;
    private timeouts;
    constructor({ blobsContext, capabilities, config, debug, frameworksAPIPaths, generatedFunctions, isConnected, logLambdaCompat, manifest, projectRoot, settings, timeouts, }: {
