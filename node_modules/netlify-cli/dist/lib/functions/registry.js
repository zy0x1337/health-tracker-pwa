...
export class FunctionsRegistry {
    ...
    settings;
    timeouts;
    constructor({ blobsContext, capabilities, config, debug = false, frameworksAPIPaths, generatedFunctions, isConnected = false, logLambdaCompat, manifest, projectRoot, settings, timeouts, }) {
