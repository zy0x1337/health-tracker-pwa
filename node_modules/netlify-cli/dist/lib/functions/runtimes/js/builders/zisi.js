...
const buildFunction = async ({ cache, config, featureFlags, func, hasTypeModule, projectRoot, targetDirectory, }) => {
    const zipOptions = {
...
export default async function detectZisiBuilder({ config, errorExit, func, metadata, projectRoot, }) {
