...
export async function runNetlifyBuild({ command, env = {}, options, settings, timeline = 'build', }) {
    ...
    const { configMutations, error: startDevError, success, generatedFunctions, } = await startDev(devCommand, startDevOptions);
